var dappleth = (function(){
	...
	var _init = function(core) {
		...
		$service.loadScripts([
			Dapp.Path + 'js/libs/dat.gui.min.js', 
			Dapp.Path + 'js/controls/OrbitControls.js', 
			Dapp.Path + 'js/libs/stats.min.js'
	...
	function init() {
		...
		container = angular.element(document.querySelector('#container'))[0];
